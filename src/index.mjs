...
const activebtns = [0, 0, 0];
//  2. Fetched array of data from Lectures.json
let lectures;
//  3. array of the buttons
let htmlbtn; let cssbtn; let jsbtn; let hreflink;
const button = [
...
function buaTilForsidu() {
  let card; let image; let img; let box; let box2; let box3; let h4; let h1; let checked; let flag;
...
function isrelevant(i) {
  ...
  let totalActiveBtns = activebtns.reduce((a, b) => a + b);
